...
const Loop = () =>{
    ...
    return(
        <form onSubmit={handleSubmit} className="w-full absolute top-[390px] left-0 xl:top-0 xl:relative xl:w-fit">
            <input ref={ref} placeholder="szukaj na stronie..." className="focus:border-none focus:outline-none placeholder:text-white w-full text-white text-base absolute pl-extrabig opacity-90 rounded-xl bg-transparent p-1 xl:placeholder:text-gray-950 xl:bg-white xl:relative xl:block xl:text-black" type="text"/>

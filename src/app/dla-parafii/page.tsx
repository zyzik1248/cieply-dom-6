...
const ForParish = () => {
    return (
        <PageLayout bg="dla-parafii" title="Dla Parafii">
            ...
            <div>
                <p className="text-base sm:text-lg m-0">Jeżeli potrzebujesz indywidualnej porady dla parafii skontaktuj się z nami na adres <Link target="_blank" className="text-green underline font-bold" href={"mailto:cieplydom@laudatosimovement.org"}>cieplydom@laudatosimovement.org</Link></p>
            </div>
            <div>
